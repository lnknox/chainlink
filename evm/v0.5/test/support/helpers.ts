...
const INVALIDVALUE: { [s: string]: any } = {
...
export let personas: { [s: string]: any } = {}
...
// newHash returns a 32-byte Uint8Array for representing a hash. str may be
// either a hexadecimal or a decimal representation. If hexadecimal, it must
// begin with '0x', and it will be padded to 32 bytes with zero bytes at the
// end. If decimal, the padding is at the beginning.
//
